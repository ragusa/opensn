...
struct Vector3
{
  double x{0.0}; // X-component of the vector
  double y{0.0}; // Y-component of the vector
  double z{0.0}; // Z-component of the vector
  ...
  [[nodiscard]] Vector3 Shifted(double value) const
  {
   ...
   */
  [[nodiscard]] Vector3 Cross(const Vector3& that) const
  {
    Vector3 newVector;
  ...
  [[nodiscard]] Vector3 InverseZeroIfSmaller(double tol) const
  {
  ...
  [[nodiscard]] Vector3 InverseOneIfSmaller(double tol) const
  {
  ...
  [[nodiscard]] std::string PrintStr() const
  {
  ...
  [[deprecated("Use PrintStr instead.")]] [[nodiscard]] std::string PrintS() const
  {
    return PrintStr();
  }
